...
`python -m admin_ui`로 실행하면 http://127.0.0.1:6100 에서 다음 세 화면을 쓸 수 있다:
...
def _host_name(host: str) -> str:
    """"127.0.0.1:6100" → "127.0.0.1", "[::1]:6100" → "::1"."""
...
def _is_cross_origin_post() -> bool:
    ...
    """
    host = request.host  # 예: "127.0.0.1:6100"
...
def main() -> None:
    ...
    print(f"메일 대시보드: http://127.0.0.1:6100  (DB: {DB_PATH})")
    app.run(host="127.0.0.1", port=6100, debug=False)
